...
const _honestySignals = {
    ...
    pipelineStale:     false,  // newest cycle_summaries > 40 min
...
function renderHonestyBanner(containerId) {
    ...
    const configs = {
        ...
        STALE: {
            ...
            detail: `Last cycle data is > 40 min old. NIFTY: ${_honestySignals.niftyAgeMin === Infinity ? '--' : _honestySignals.niftyAgeMin + 'm'} · BANKNIFTY: ${_honestySignals.bankniftyAgeMin === Infinity ? '--' : _honestySignals.bankniftyAgeMin + 'm'}. Pipeline may not be running.`,
        },
        MARKET_CLOSED: {
